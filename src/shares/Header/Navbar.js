...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar bg-base-100 pl-12 pr-[75px] mt-[28px]">
                <div className="navbar-start">
                    ...
                    <img className='w-[227px] h-[83.99px]' src={logo} alt="logo" />
                </div>
                ...
                <div className="navbar-end">
                    <div className="dropdown dropdown-hover lg:hidden font-semibold mr-[30px]">
                        <label tabIndex={0} className="hover:text-green-400 font-semibold text-xl ">FACILITIES</label>
                    ...
                    <div className="dropdown dropdown-bottom dropdown-end">
                        ...
                        <label tabIndex={0} className="  font-semibold text-xl hover:text-green-400">Portal</label>
