                        ...
                        <div>
                            ...
                            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 gap-2">
                                    ...
                                    <tbody>
                                        {
                                            [...Array(3)?.keys()].map((tableRow: number, index: number) => (
                                                <tr
                                                    key={index}
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <span>A student named (********) id : 191***** has been bullying all the students and threating to hurt them if they don’t ovey him. he also smoke.</span>
                                                    </td>
                                                    <td className="px-6 py-4">
