                        ...
                        <div>
                            ...
                            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 gap-2">
                                    ...
                                    <tbody>
                                        {
                                            [...Array(2)?.keys()].map((tableRow: number, index: number) => (
                                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <button className="bg-red-600 text-white rounded-lg px-2 py-1 cursor-no-drop">Cancel</button>
                                                    </td>
                                                </tr>
                                            ))
                                        }
